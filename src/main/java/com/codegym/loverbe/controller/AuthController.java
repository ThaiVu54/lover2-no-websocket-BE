...
public class AuthController {
    ...
    public ResponseEntity<?> register(@Valid @RequestBody SignUpForm signUpForm) {
        ...
        user.setAvatar("https://firebasestorage.googleapis.com/v0/b/lover-4a315.appspot.com/o/z2991517625512_44867f24c34add5c41afac4a6f6e5b9f.jpg?alt=media&token=734ffdf5-dac8-4e1a-8ed2-330c57f99f93");
